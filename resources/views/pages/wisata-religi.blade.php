...
<head>
    ...
    <title>Daftar Wisata Religi | PT. ASH SHAFA MARWAH INDONESIA</title>
    ...
    <main class="py-12">
        <div class="container mx-auto px-4">
            <h1 class="text-3xl font-extrabold text-shafa-primary text-center mb-10">
                JELAJAH WISATA RELIGI DUNIA
            </h1>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">

                @forelse ($wisataReligiPackages as $package)
                    <div
                                ...
                                <div class="text-xs sm:text-sm text-shafa-text space-y-2">
                                    <div class="grid grid-cols-2 gap-x-2">
                                        ...
                                        <div class="flex items-center gap-1"><i
                                                class="fas fa-calendar-alt text-shafa-primary"></i><span>{{ \Carbon\Carbon::parse($package->departure_date)->translatedFormat('d F Y') }}</span>
                                        </div>
                                    ...
                                    @if ($package->other_hotels)
                                        <div class="flex items-center gap-1"><i
                                                class="fas fa-hotel text-shafa-primary"></i><span>{{ $package->other_hotels }}</span>
                                        </div>
                                    @endif
                                </div>
                ...
                @empty
                    <div class="col-span-1 md:col-span-4 text-center py-12 bg-white rounded-lg shadow-lg">
                        ...
                        <h3 class="text-xl font-semibold text-shafa-dark-text">Belum Ada Paket Wisata Religi</h3>
                        <p class="text-shafa-text mt-2">Silakan tambahkan paket dengan kategori "Wisata Religi" atau
                            "Umroh Plus" di panel admin.</p>
                    </div>
                @endforelse
            </div>
