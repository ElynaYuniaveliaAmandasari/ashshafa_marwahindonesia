...
<head>
    ...
    <title>Daftar Paket Haji | PT. ASH SHAFA MARWAH INDONESIA</title>
...
<body class="font-sans bg-gray-50">
                    ...
                    <li class="relative">
                        ...
                        <ul id="layanan-menu"
                            ...
                            <li><a href="{{ url('/pages/wisata-religi') }}"
                                    class="block px-4 py-2 hover:bg-gray-100">Wisata
                                    Religi</a>
                            </li>
                            <li><a href="{{ url('/pages/produk-lain') }}"
                                    class="block px-4 py-2 hover:bg-gray-100">Produk
                                    Lain</a>
                            </li>
                        </ul>
                    </li>
    ...
    <main class="py-12">
        <div class="container mx-auto px-4">
            <h1 class="text-3xl font-extrabold text-shafa-primary text-center mb-10">PILIHAN PAKET HAJI</h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                                ...
                                <div class="text-xs sm:text-sm text-shafa-text space-y-2">
                                    <div class="grid grid-cols-2 gap-x-2">
                                        ...
                                        <div class="flex items-center gap-1"><i
                                                class="fas fa-calendar-alt text-shafa-primary"></i><span>{{ \Carbon\Carbon::parse(explode(',', $package->departure_date)[0])->translatedFormat('d F Y') }}</span>
                                        </div>

                                        <div class="flex items-center gap-1"><i
                                                class="fas fa-plane text-shafa-primary"></i><span>{{ $package->airline }}</span>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-2 gap-x-2">

                                        <div class="flex items-center gap-1"><i
                                                class="fas fa-hotel text-shafa-primary"></i><span>{{ $package->hotel_makkah ?? 'Hotel Makkah' }}</span>
                                        </div>

                                        <div class="flex items-center gap-1"><i
                                                class="fas fa-location-dot text-shafa-primary"></i><span>{{ $package->departure_city }}</span>
                                        </div>
                                    </div>

                                    <div class="flex items-center gap-1"><i
                                            class="fas fa-hotel text-shafa-primary"></i><span>{{ $package->hotel_madinah ?? 'Hotel Madinah' }}</span>
                                    </div>
                                </div>
                                <div class="border-t mt-4 pt-3 space-y-2">
                                    <div>
                                        ...
                                        <div class="flex justify-between items-center text-xs sm:text-sm">
                                            ...
                                            <span class="font-semibold text-shafa-primary">{{ round($percentage) }}%
                                                Terisi</span>
                                        </div>
                ...
                @empty
                    <div class="col-span-1 md:col-span-4 text-center py-12 bg-white rounded-lg shadow-lg">
                        ...
                        <h3 class="text-xl font-semibold text-shafa-dark-text">Belum Ada Paket Haji</h3>
                        <p class="text-shafa-text mt-2">Silakan tambahkan paket dengan kategori "Haji" di panel admin.
                        </p>
                    </div>
                @endforelse
            </div>
    ...
    <footer class="bg-shafa-primary text-white text-center py-4 mt-10 mt-12">
        <div
