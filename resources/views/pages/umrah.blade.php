...
<head>
    ...
    <title>Daftar Paket Umroh | PT. ASH SHAFA MARWAH INDONESIA</title>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                @empty
                    <div class="col-span-1 md:col-span-4 text-center py-12 bg-white rounded-lg shadow-lg">
                        ...
                        <h3 class="text-xl font-semibold text-shafa-dark-text">Belum Ada Paket Umroh</h3>
                        <p class="text-shafa-text mt-2">Silakan tambahkan paket dengan kategori "Umroh" atau "Umroh
                            Plus" di panel admin.</p>
                    </div>
                @endforelse
            </div>
        </div>
